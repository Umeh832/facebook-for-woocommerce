...
class WC_Facebookcommerce extends WooCommerce\Facebook\Framework\Plugin {
	...
	public function init() {
		...
		// Handle localization plugin activation/deactivation
		add_action( 'activated_plugin', array( $this, 'handle_localization_plugin_change' ) );
		add_action( 'deactivated_plugin', array( $this, 'handle_localization_plugin_change' ) );
